...
class ContactForm(forms.Form):
	...
	message = forms.CharField(required=True,widget=forms.Textarea(attrs={'required':'required','placeholder':"message"}));
	code = forms.CharField(required=True,widget=forms.TextInput(attrs={'required':'required','placeholder':"img code",'style':'width:100px'}));
